@component('mail::message', ['content' => $data, 'type' => 'home'])
    ...
    <p style="margin-bottom: 30px">Leuk dat je meedoet aan de Oostpoort cadeaupakketten winactie. Het enige wat jij nog hoeft te doen, is je e-mailadres te bevestigen. Vervolgens staat alleen nog een beetje mazzel jou in de weg om het cadeaupakket ter waarde van €100 te winnen! </p>
    <a class="btn btn-primary" href="{{ $content['url'] }}">Bevestig e-mailadres</a>
